...
public class Stat_AboForm {
   Resources theme ; 
    ...
    protected CategorySeries buildCategoryDataset(String title, ArrayList<abonnement> ab) {
        ...
        for (abonnement u : ab) {
            series.add(u.getDate(), u.getPrix());
    ...
    public void createPieChartForm(String titre, ArrayList<abonnement> ab) {
        ...
        // Set up the renderer
        int[] colors = new int[]{ColorUtil.rgb(255,102,1), ColorUtil.GREEN, ColorUtil.MAGENTA, ColorUtil.YELLOW, ColorUtil.CYAN, ColorUtil.BLACK};
